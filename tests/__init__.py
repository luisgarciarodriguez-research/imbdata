"""
tests — Test suite for the imbdata package.

Marks the directory as a package so the shared fixtures in ``conftest`` can be
imported with a relative import from the test modules.
